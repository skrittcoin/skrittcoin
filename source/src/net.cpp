...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SkrittCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"18.236.33.200", "18.236.33.200"},
    {"34.211.217.27", "34.211.217.27"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SkrittCoin is probably already running."), addrBind.ToString().c_str());
        else
